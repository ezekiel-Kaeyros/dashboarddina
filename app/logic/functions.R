...
generate_barplot <- function(data, text) {
  plotly::plot_ly(data, x = ~Var1,
                  type = "bar",
                  y = ~percentage,
                  marker = list(color = couleurs <- c("#e6eff0", "#cddee1", "#b3ced3", "#9abdc4", "#81adb5", "#689ca6", "#4f8c97", "#357b89",
                                                      "#1c6b7a", "#035a6b", "#035160", "#024856", "#023f4b", "#023640", "#022d36", "#01242b",
                                                      "#011b20", "#011215", "#00090b", "#000000")
...
generate_piechart <- function(data, text) {
  plotly::plot_ly(data, labels = ~Var1,
                  ...
                  text = ~paste(paste(text, ":", Var1),
                                ...
                                "<br>Prozentsatz:", pct1),
                  marker = list(colors = couleurs <- c("#e6eff0", "#cddee1", "#b3ced3", "#9abdc4", "#81adb5", "#689ca6", "#4f8c97", "#357b89",
                                                       "#1c6b7a", "#035a6b", "#035160", "#024856", "#023f4b", "#023640", "#022d36", "#01242b",
                                                       "#011b20", "#011215", "#00090b", "#000000")
                                ,
...
generate_groupedbarplot <- function(data, text1,text2){
  yiord_palette <- couleurs <- c("#e6eff0", "#cddee1", "#b3ced3", "#9abdc4", "#81adb5", "#689ca6", "#4f8c97", "#357b89",
                                 "#1c6b7a", "#035a6b", "#035160", "#024856", "#023f4b", "#023640", "#022d36", "#01242b",
                                 "#011b20")
